...
**Polymer-based mods are an exception.** Although serverside, some work, partially don't work, or just don't work at all.
└> You can try checking if Geyser/Bedrock support is listed on the mod page.
‍     └> If not, your best option is to try it and see.
