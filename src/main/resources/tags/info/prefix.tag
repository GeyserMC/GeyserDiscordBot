...
We strongly recommend that you **do not remove** the prefix, but instead change it. **Should a Java player and a Bedrock player join your server at the same time, things could break and the users could lose their data!**
