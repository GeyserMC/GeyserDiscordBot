...
- If your using Geyser-Fabric or Geyser-NeoForge, please see this [page](https://geysermc.org/wiki/geyser/supported-versions/#fabric-neoforge-servers) for support of older versions.