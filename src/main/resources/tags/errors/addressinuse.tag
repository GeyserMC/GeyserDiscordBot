...
If you are using a server hosting provider and get this error, you likely need to use a specific port allocated to you. Use the [Setup guide](https://wiki.geysermc.org/geyser/setup/) for instructions on how to configure Geyser.