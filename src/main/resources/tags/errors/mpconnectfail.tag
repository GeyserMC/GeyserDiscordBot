...
- If you are self-hosting and cannot get port forwarding to work, use playit.gg which is a alternative to port forwarding. Run `!!playit` for more info.
└> If you are having issues with playit.gg, run `!!playitdebug`.
- Having voicechat plugins/mods on the same port as Geyser can also cause this error.
