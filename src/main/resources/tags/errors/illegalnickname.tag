...
You can ask the developer of that plugin for how to solve this issue.
This is software piracy and is illegal!. By setting your server as so, you are condoning the use of piracy.
