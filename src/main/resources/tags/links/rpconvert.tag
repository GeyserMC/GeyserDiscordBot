...
As an alternative, you can use [Rainbow](https://github.com/GeyserMC/Rainbow) which is experimental and generates Geyser item mappings and Bedrock resourcepacks for 1.21.4+ packs to Custom Item API V2. Run !!rainbow for more info.