type: text
title: :geyser: Network Debugging
color: help
aliases: nd
...
- Look for a section in your panel for allocating ports, make a new allocation and use the port there as the Bedrock port in the Geyser config (ensure that you disable `clone-remote-port` before doing this). If you can't find a section for this, skip this step.
