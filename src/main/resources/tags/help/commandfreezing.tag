...
Alternatively, you can try and reduce the amount of commands sent to Bedrock edition players - for example by using the HideCommands extension linked below.
