...
The most common issue when setting up playit.gg is confusing the Geyser and playit.gg ports which are entirely separate. To fix this, in Geyser config, change the bedrock port back to the default of 19132 and ensure that `clone-remote-port=false`.
