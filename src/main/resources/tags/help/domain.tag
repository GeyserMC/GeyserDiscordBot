...
title: :geyser: Domain Guide
color: help

---

Before starting this domain guide, please make you are able to connect to your Geyser server with the **Numeric IP + Port**. If not, follow the Geyser [setup guide](https://wiki.geysermc.org/geyser/setup/). To setup a domain for Geyser:
...
5. Connect to your server with your domain and port.