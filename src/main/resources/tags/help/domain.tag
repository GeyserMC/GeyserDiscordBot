...
Before starting this domain guide, please make you are able to connect to your Geyser server with the **Numeric IP + Port**. If not, follow the Geyser setup guide. To setup a domain for Geyser:
