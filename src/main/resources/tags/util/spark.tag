...
Spark is a plugin/mod that helps you monitor performance for your server. Paper has spark built-in and does not need to be installed manually. The download link for Spark can be found below.
