...
Installing Floodgate on the backend servers also makes it to that Bedrock player's don't have to switch backend servers for their skins to start displaying.
